...
urlpatterns = [
    ...
    path(
        "customer-orders-cancel/<int:order_id>",
        views.customer_orders_cancel,
        name="customer_orders_cancel",
    ),
]
